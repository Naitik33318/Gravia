...
def welcome_notification():
    notification.notify(
        ...
        app_icon = r"G:\Programming\Python Projects\Gravia\Icons\Gravia icon.ico",
        timeout = 1,
    )
...
if __name__ == "__main__":
    ...
    while True:
            ...
            if 'wikipedia' in query:  #if wikipedia found in the query then this block will be executed
                ...
                speak("Ok. here you go to spotify. Pleasewait for a moment\n")
                print("Opening.....")
                ...
                soundPath = "C:\\Users\\Sandeep\\Downloads\\mixkit-wild-lion-animal-roar-6.wav"
                speak("Playing sound")
